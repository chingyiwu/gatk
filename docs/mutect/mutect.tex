...
gatk Mutect2 -R reference.fasta \
   ...
   # Mutect2 may input the orientation bias model learned by CollectF1R2Counts
   # and LearnReadOrientationModel for any tumor sample suspected of orientation artifacts
